...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # It takes as a match the first match, even though there is a match after.
  # "Greedy" operators will search from left to right and the first match will make it stop.
  ...
  # The alternation means or. The character class is an and. Both groups must match.
